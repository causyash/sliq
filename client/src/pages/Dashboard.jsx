  ...
  return (
    <Layout>
      <div className="mb-10 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Your Workspaces</h1>
          <p className="mt-2 text-gray-500">Manage your teams and organized projects efficiently.</p>
        </div>
        <button 
